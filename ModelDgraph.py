...
def menu_dgraph(client):
    while True:
        print("""
======== CONSULTAS DGRAPH ========
1. Crear datos de ejemplo
2. Buscar usuario
3. Ver favoritos del usuario
4. Ver devoluciones del usuario
5. Agregar producto a favoritos
6. Registrar devolución
7. Ver recomendaciones por categoría
...
""")
        try:
            ...
            if opcion == 1:
                ...
                search_users(client, username)
            elif opcion == 3:
                username = input("Ingrese el username: ")
                favoritos_del_usuario(client, username)
            elif opcion == 4:
                username = input("Ingrese el username: ")
                devoluciones_por_usuario(client, username)
            elif opcion == 5:
                username = input("Ingrese el username: ")
                producto = input("Ingrese el nombre del producto: ")
                guardar_en_favoritos(client, username, producto)
            elif opcion == 6:
                username = input("Ingrese el username: ")
                producto = input("Producto a devolver: ")
                motivo = input("Motivo de la devolución: ")
                registrar_devolucion(client, producto, motivo, username)
            elif opcion == 7:
                username = input("Ingrese el username: ")
                recomendaciones_por_categoria(client, username)
            elif opcion == 8:
                drop_all(client)
                print("Datos eliminados de Dgraph.")
            elif opcion == 9:
                print("Saliendo del menú de Dgraph.")
                break
            else:
